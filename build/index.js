...
Module['FS_createPath']("/assets", "scenes", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/arial.ttf", "start": 0, "end": 367112}, {"filename": "/assets/scenes/loss_scene.json", "start": 367112, "end": 368095}, {"filename": "/assets/scenes/main_scene.json", "start": 368095, "end": 370674}, {"filename": "/assets/scenes/scenes.json", "start": 370674, "end": 371133}, {"filename": "/assets/scenes/select_scene.json", "start": 371133, "end": 373246}, {"filename": "/assets/scenes/start_scene.json", "start": 373246, "end": 375131}, {"filename": "/assets/scenes/win_scene.json", "start": 375131, "end": 376112}], "remote_package_size": 376112});

  })();

// end include: /tmp/tmpai53u5ab.js
// include: /tmp/tmp6sphmusk.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp6sphmusk.js
// include: /tmp/tmpa860u0ov.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpa860u0ov.js
